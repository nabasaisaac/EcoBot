...
export const AboutRobotPage = () => {
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden bg-background dark:bg-background-dark font-display text-on-surface">
      <div className="layout-container flex h-full grow flex-col">
        <div className="px-4 lg:px-20 xl:px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1 gap-10">
            {/* TopNavBar */}
            <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-border-color dark:border-white/10 px-4 md:px-10 py-3">
              <div className="flex items-center gap-4 text-on-surface dark:text-white">
                ...
                <h2 className="text-on-surface dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">
                  EcoBot Admin
                </h2>
              </div>
              <div className="hidden md:flex flex-1 justify-end gap-8">
                <div className="flex items-center gap-9">
                  <Link
                    to="/admin-dashboard"
                    className="text-on-surface-secondary dark:text-white/70 hover:text-primary transition-colors text-sm font-medium leading-normal"
                  >
                    Dashboard
                  </Link>
                  <a
            ...
            <main>
              <div
                className="flex min-h-[480px] flex-col gap-6 sm:gap-8 bg-cover bg-center bg-no-repeat sm:rounded-lg items-center justify-center p-4"
                style={{
                  backgroundImage: `linear-gradient(rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.8) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuBuL6JuGs6kfkIv6dD5VTppETT3b4Fzp7mgkEwKRN-3deBP3r5Ffy8i99SPduvRHC8L8yldURE-x2ZE4nKlVV2B3nY2HvpAbxOmkTA3qsAlMQeHVp29nOLIt2SLZOzS1YNlfi9cMz7dR6btLQ8x200EUcOept4NJNz0ztxmi7PrA04vBzq_yZyYPexgL3NHQmF7oyXZCS_LTGDF-21HbfgV4w0enITuoXdS8LTTMoCV23Q5LOdTjrZkFM41kCjSYLm7QzL9krYLOwM")`,
                }}
              >
                <div className="flex flex-col gap-2 text-center max-w-2xl">
                  <h1 className="text-on-surface dark:text-white text-4xl sm:text-5xl font-black leading-tight tracking-[-0.033em]">
                    Meet EcoBot: The Future of Autonomous Waste Management
                  </h1>
                  <h2 className="text-on-surface-secondary dark:text-white/80 text-sm sm:text-base font-normal leading-normal">
                    An intelligent, autonomous robot designed to create cleaner
                    public spaces through advanced technology.
                  </h2>
                </div>
              </div>
              ...
              <section className="mt-10">
                <h2 className="text-on-surface dark:text-white text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">
                  Core Functions
                </h2>
                <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 p-4">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex flex-1 gap-3 rounded-lg border border-border-color dark:border-white/10 bg-surface dark:bg-white/5 p-4 flex-col hover:border-primary/50 transition-colors"
                    >
                      ...
                      <div className="flex flex-col gap-1">
                        <h3 className="text-on-surface dark:text-white text-base font-bold leading-tight">
                          {func.title}
                        </h3>
                        <p className="text-on-surface-secondary dark:text-white/70 text-sm font-normal leading-normal">
                          {func.desc}
                        </p>
                      </div>
                    </div>
              ...
              <section className="mt-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 p-4">
                  <div>
                    <h2 className="text-on-surface dark:text-white text-[22px] font-bold leading-tight tracking-[-0.015em] pb-3 pt-5">
                    ...
                    <div className="flex flex-col gap-3 mt-4">
                      {[
                        ...
                        <details
                          key={idx}
                          className="group rounded-lg bg-surface dark:bg-white/5 border border-border-color dark:border-white/10 p-4 open:border-primary"
                          open={tech.open}
                        >
                          <summary className="flex cursor-pointer list-none items-center justify-between text-base font-bold text-on-surface dark:text-white">
                            {tech.title}
                            <div className="text-on-surface-secondary dark:text-white/70 transition-transform duration-300 group-open:rotate-180">
                              <span className="material-symbols-outlined">
                                expand_more
                              </span>
                            </div>
                          </summary>
                          <p className="mt-2 text-sm text-on-surface-secondary dark:text-white/70">
                            {tech.desc}
                          </p>
                        </details>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="mt-4 relative rounded-lg border border-border-color dark:border-white/10 bg-surface dark:bg-white/5 p-4 aspect-[4/3] flex items-center justify-center">
                      <img
              ...
              <section className="mt-10 p-4">
                <div className="rounded-lg bg-surface dark:bg-white/5 border border-border-color dark:border-white/10 p-6 lg:p-10">
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    <div className="lg:col-span-3">
                      <h2 className="text-on-surface dark:text-white text-[22px] font-bold leading-tight tracking-[-0.015em]">
                        Our Mission & Environmental Impact
                      </h2>
                      <p className="text-on-surface-secondary dark:text-white/70 text-sm mt-4">
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-4">
                      <div className="flex items-center gap-4 rounded-lg bg-primary/10 dark:bg-primary/20 p-4">
            ...
            {/* Footer */}
            <footer className="mt-10 border-t border-border-color dark:border-white/10 px-4 py-6 text-center text-on-surface-secondary dark:text-white/70">
